...
for ds_name, report_key in datasets:
    ...
    base_f1 = np.array([run[report_key]['macro avg']['f1-score'] for run in base_data['runs']])
    tapt_f1 = np.array([run[report_key]['macro avg']['f1-score'] for run in tapt_data['runs']])
    aug_f1 = np.array([run[report_key]['macro avg']['f1-score'] for run in aug_data['runs']])
    tapt_aug_f1 = np.array([run[report_key]['macro avg']['f1-score'] for run in tapt_aug_data['runs']])
